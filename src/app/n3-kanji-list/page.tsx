...
import styles from './n3-kanji-list.module.css';
...
const NOTES_DATA = [
  {
    ...
    content: 'N3 is the intermediate level of the JLPT and introduces more complex kanji characters. These build upon the N4 and N5 foundations to expand your reading and writing capabilities.'
  },
  {
    id: 'usage',
    title: 'Common Usage',
    content: 'These kanji are commonly found in newspapers, magazines, and everyday written communication. They include more complex concepts, business terms, and abstract ideas.'
  },
  {
    id: 'tips',
    title: 'Study Tips',
    content: "Focus on understanding both readings (kun'yomi and on'yomi) and practice recognizing these kanji in compound words. Many N3 kanji combine with simpler kanji to form common vocabulary."
  },
  {
    id: 'review',
...
export default function N3KanjiListPage() {
  ...
  return (
    <div className={styles.container}>
      <h1 className={styles.heading}>JLPT N3 Kanji</h1>
      <p className={styles.description}>
        Master intermediate Japanese kanji required for the JLPT N3 level.
            ...
            <div key={index} className={styles.cardWrapper}>
              <div className={styles.card}>
                <div className={styles.cardFront}>
                  <div className={styles.cardLevel}>N3</div>
      ...
      <div className={styles.notesSection}>
        <h2 className={styles.notesTitle}>About N3 Kanji</h2>
