...
/**
 * API route to fetch vocabulary data from CSV files
 */
export async function GET() {
  try {
    const allVocabulary = await loadAllVocabulary();
    return NextResponse.json(allVocabulary);
  } catch (error) {
 ...
 */
async function loadAllVocabulary(): Promise<VocabularyData[]> {
