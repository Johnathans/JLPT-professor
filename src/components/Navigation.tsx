...
import { Home, School, MenuBook, Assessment, Person } from '@mui/icons-material';
...
export default function Navigation() {
  ...
  const routes = [
    ...
    { label: 'Practice', icon: <MenuBook />, path: '/practice' },
    { label: 'Tests', icon: <Assessment />, path: '/tests' },
    { label: 'Profile', icon: <Person />, path: '/profile' },
  ];

  const getCurrentValue = () => {
    return routes.findIndex(route => pathname === route.path) || 0;
  };
